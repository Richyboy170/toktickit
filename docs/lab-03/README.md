...
The staged Git flow, commit order, approved merges, final-main CI, and closed Issues are rendered
...
The contract extends Lab 2 and must be updated before an implementation change if a route, role, status, migration, or acceptance decision changes. Final delivery claims are tied to immutable PR, commit, CI, artifact, Issue, and screenshot evidence.
